...
#
# Env:
#   CHAMA_DEPLOY_KEY   SSH key authorised for satoshi@satoshimarket.app
#                      (default: ~/.ssh/.id_satoshi_market — the maintainer's path)
...
DEST="satoshi@satoshimarket.app:~/chama-landing/"

[ -f "$DEPLOY_KEY" ] || { echo "❌ SSH key not found: $DEPLOY_KEY — set CHAMA_DEPLOY_KEY to the key for satoshi@satoshimarket.app."; exit 1; }
